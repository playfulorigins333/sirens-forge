    ...
    <div className="min-h-screen bg-black text-white py-16 px-4">
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-sm mt-2 opacity-80">5 Generations Only</p>
        ...
        >
          ...
          <p className="text-sm opacity-80">First 120 Only</p>
          <div className="mt-6 bg-white text-black font-bold py-3 rounded-full">
            Lock In
          </div>
        </button>
        ...
        <button
          ...
          disabled={loading}
          className="bg-gradient-to-br from-amber-700 to-yellow-900 p-8 rounded-3xl text-center transform transition hover:scale-105 ring-4 ring-yellow-500 shadow-2xl disabled:opacity-50 animate-pulse"
        >
          <h3 className="text-2xl font-bold">OG Eternal Throne</h3>
          <p className="text-3xl font-bold mt-2">$1,333</p>
          <p className="text-sm opacity-80">LAST 10/35</p>
          <div className="mt-6 bg-white text-black font-bold py-3 rounded-full">
            Secure Throne
          </div>
        </button>
      ...
      {/* FOOTER */}
      <p className="text-center mt-20 text-xs text-gray-500">
        © 2025 Eleven Sparks LLC. All rights reserved.
      </p>
    </div>
  );
}