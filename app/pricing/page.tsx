    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="flex justify-center mb-16">
        <div className="relative">
          <div className="absolute -inset-3 bg-gradient-to-r from-red-600 to-pink-600 rounded-full blur-2xl opacity-75 animate-pulse"></div>
          <Countdown type="og" />
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-12 max-w-7xl mx-auto px-6">
        ...
        <div className="group relative">
          <div className="absolute -inset-2 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-3xl blur-xl opacity-70 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
          <button
            onClick={() => checkout('price_1SRxf9FjcWRhhOnzXdiKLvvk', 'Starter Hit')}
            disabled={loading === 'price_1SRxf9FjcWRhhOnzXdiKLvvk'}
            className="relative bg-black border border-cyan-500/50 p-10 rounded-3xl text-center transform transition-all hover:scale-105 hover:border-cyan-400 shadow-2xl disabled:opacity-50 w-full"
          >
            ...
            <div className="mt-8 inline-block">
              <div className="bg-gradient-to-r from-cyan-400 to-blue-500 text-black font-bold text-lg py-4 px-12 rounded-full shadow-lg transform transition hover:scale-110">
                {loading === 'price_1SRxf9FjcWRhhOnzXdiKLvvk' ? 'Loading...' : 'Claim 5 Generations'}
              </div>
            </div>
          </button>
        </div>
        ...
        {/* $29.99 */}
        <div className="group relative">
          <div className="absolute -inset-2 bg-gradient-to-r from-purple-500 to-pink-600 rounded-3xl blur-xl opacity-70 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
          <button
            onClick={() => checkout('price_1SRxiNFjcWRhhOnzHVXW0cYi', 'Eternal Seat')}
            disabled={loading === 'price_1SRxiNFjcWRhhOnzHVXW0cYi'}
            className="relative bg-black border border-purple-500/50 p-10 rounded-3xl text-center transform transition-all hover:scale-105 hover:border-purple-400 shadow-2xl disabled:opacity-50 w-full"
          >
            ...
            <div className="mt-8 inline-block">
              <div className="bg-gradient-to-r from-purple-400 to-pink-500 text-black font-bold text-lg py-4 px-12 rounded-full shadow-lg transform transition hover:scale-110">
                {loading === 'price_1SRxiNFjcWRhhOnzHVXW0cYi' ? 'Loading...' : 'Lock In Before 0/120'}
              </div>
            </div>
          </button>
        </div>
        ...
        <div className="group relative">
          ...
          <button
            onClick={() => checkout('price_1SRzMSFjcWRhhOnzmON74k5O', 'OG Throne')}
            disabled={loading === 'price_1SRzMSFjcWRhhOnzmON74k5O'}
            className="relative bg-gradient-to-br from-amber-900/90 to-black p-10 rounded-3xl text-center transform transition-all hover:scale-105 ring-4 ring-yellow-500/50 shadow-2xl border border-yellow-600/30 disabled:opacity-50 w-full"
          >
            ...
            <div className="mt-8 inline-block">
              <div className="bg-gradient-to-r from-yellow-400 to-amber-600 text-black font-bold text-xl py-5 px-16 rounded-full shadow-2xl transform transition hover:scale-110 hover:shadow-yellow-500/50">
                {loading === 'price_1SRzMSFjcWRhhOnzmON74k5O' ? 'Loading...' : 'Secure Throne Forever'}
              </div>
            </div>
          </button>
        </div>
